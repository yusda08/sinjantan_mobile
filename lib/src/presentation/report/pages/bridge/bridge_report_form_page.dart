...
class BridgeReportFormPage extends StatefulWidget implements AutoRouteWrapper {
  @override
  _BridgeReportFormPageState createState() => _BridgeReportFormPageState();
...
class _BridgeReportFormPageState extends State<BridgeReportFormPage> {
  ...
  sendPengaduan() {
    if (_formKey.currentState!.validate()) {
      ...
      final formData = ReportReqObj(
          ...
          listFile: _fileImage);
      context.read<ReportCubit>().sendBridgeReport(formData);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FORM PENGADUAN JEMBATAN',
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          labelText: 'Tuliskan nama jembatan',
